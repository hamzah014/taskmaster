                            ...
                            <div class="row">
                                <div class="col s12">
                                    <span class="header-button">
                                        <h4 class="card-title">{{ __('Kemaskini Maklumat Pengguna')}}</h4>
                                    </span>
                                    <div class="row">
                                        <div class="col m12">
                                            <div class="tab" style="display:inline-flex !important;">
                                                ...
                                                <button class="tablinks" onclick="openTab(event, 'maklumatGambar')">Maklumat Gambar</button></br>
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <table >
                                                        ...
                                                        <div id="maklumatPengguna" class="tabcontent">
                                                            ...
                                                            <div class="row">
                                                                <div class="col m12 s12">
                                                                    @include('setting.user.include.maklumatPengguna')
                                                                </div>
                                                            </div>
                                                        </div>
