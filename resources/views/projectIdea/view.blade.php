                    ...
                    <div class="card">
                                ...
                                <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 fw-bold" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a id="analysis_tab" class="nav-link justify-content-center text-active-gray-800 active" data-bs-toggle="tab" role="tab" href="#analysis_content">
                                            <span class="badge badge-dark me-2">2</span> Requirements Analysis
                                        </a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a id="score_tab" class="nav-link justify-content-center text-active-gray-800" data-bs-toggle="tab" role="tab" href="#score_content">
                                            <span class="badge badge-dark me-2">3</span> Requirements Analysis & Prioritization
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div id="score_content" class="card-body p-0 tab-pane fade" role="tabpanel" aria-labelledby="score_content">
                                    <div class="w-100">

                                        <div id="scoreInfo">
                                            <div class="fv-row mb-8 mt-5">
                                                <label class="d-flex align-items-center fs-5 fw-semibold mb-4">
                                                    <span class="">Requirements Analysis & Prioritization:</span>
                                                </label>
                                            </div>
                                            <div class="fv-row mb-8">
                                                <label class="d-flex align-items-center fs-5 fw-semibold mb-4">
