                ...
                <div class="card-body p-9">
                                ...
                                <div id="idea_content" class="card-body p-0 tab-pane fade show active" role="tabpanel" aria-labelledby="idea_content">
                                    <div class="w-100">
                                        <form id="projectIdeaForm" class="ajax-form-register" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="fv-row">
                                                <a onclick="confirmSubmitIdea()" class="btn btn-warning btn-sm">Submit</a>
                                            </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12 text-start">
                            <a class="btn btn-secondary btn-sm" href="{{ route('project.idea.index') }}"><i class="fa fa-chevron-left"></i> Back</a>
                        </div>
                    </div>
