						...
						<div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20 full-opacity">
							<form class="ajax-form w-100" id="login-form" action="{{ route('login.validate') }}" method="POST">
								...
								<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-10">
									<div class="">
										<a href="{{ route('register.index') }}" class="link-primary text-light text-underline">Register Account</a>
									</div>
									<div></div>
									<a href="#" class="link-primary text-light text-underline" data-bs-toggle="modal" data-bs-target="#modal-forgot">Forgot Password?</a>
								</div>
