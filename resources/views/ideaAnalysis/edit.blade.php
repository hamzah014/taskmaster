                ...
                <div class="card-body p-9">
                                ...
                                <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 fw-bold" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a id="idea_tab" class="nav-link justify-content-center text-active-gray-800 active" data-bs-toggle="tab" role="tab" href="#idea_content">
                                            <span class="badge badge-dark me-2">2</span> Idea Analysis
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12 text-start">
                            <a class="btn btn-secondary btn-sm" href="{{ route('project.idea.analysis.index') }}"><i class="fa fa-chevron-left"></i> Back</a>
                        </div>
                    </div>
                </div>
            </div>
		...
		(function ($) {
            ...
            table = $('#project-tab').DataTable({
                ...
                columns: [
                    ...
                    { name: 'PI_ReqComplete', data: 'PI_ReqComplete', class: 'text-center' },
