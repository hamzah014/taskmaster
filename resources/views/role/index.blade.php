			...
			<div class="card-body p-9">
                            ...
                            <div class="fs-6 ms-1 p-10" style="">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <label for="search_role" class="form-label">Peranan</label>
                                        {!! Form::select('search_role', $userRole , null, [
                                            'id' => 'search_role',
                                            'class' => 'form-select',
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-end">
                                        <a href="#" onclick="searchRole()" class="btn btn-sm btn-dcms">Search</a>
                                    </div>
                                </div>
                ...
                <div class="row flex-row mt-10 card p-5 bg-section card-no-border">
                    ...
                    <div class="col-md-12 text-end mb-5">
                        <a href="{{ route('role.create') }}" class="btn btn-success btn-sm text-white">
                            <i class="fas fa-add fs-1x text-white"></i> Add Role
                        </a>
                    </div>
                    @endif
                    ...
                    <div class="col-md-12 ">
                        <div class="responsive-table">
                            <table class="dcms-table" id="role-tab">
    ...
    <script>
        (function ($) {
            ...
            var table = $('#role-tab').DataTable({
                ...
                ordering:false,
                ajax:  {
                    "url" :"{{ route('role.roleDatatable') }}",
                    "method": 'POST',
                },
                order: [[1, 'desc']],
                columns: [
                    { name: 'indexNo', data: 'indexNo', class: 'text-center' },
                    { name: 'RLName', data: 'RLName', class: '' },
                    { name: 'RLActive', data: 'RLActive', class: '' },
        ...
        function searchRole(){
            ...
            if ($.fn.DataTable.isDataTable('#role-tab')) {
                $('#role-tab').DataTable().destroy();
            }

            $.ajax({
                url: "{{ route('role.searchRole') }}",
                type: 'POST',
                headers: {
