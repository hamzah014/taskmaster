...
<div class="card">
            ...
            <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 fw-bold" role="tablist">
                <li class="nav-item" role="presentation">
                    <a id="info_tab" class="nav-link justify-content-center text-active-gray-800 active" data-bs-toggle="tab" role="tab" href="#info_content">
                        <span class="badge badge-dark me-2 p-2"> </span> Task Detail
                    </a>
                </li>

                @if($taskProject->TPAssignee == $user->USCode)

                <li class="nav-item" role="presentation">
                    <a id="update_tab" class="nav-link justify-content-center text-active-gray-800" data-bs-toggle="tab" role="tab" href="#update_content">
                        <span class="badge badge-dark me-2 p-2"> </span> Task Update
                    </a>
                </li>
                ...
                <li class="nav-item" role="presentation">
                    <a id="task_tab" class="nav-link justify-content-center text-active-gray-800" data-bs-toggle="tab" role="tab" href="#task_content">
                        <span class="badge badge-dark me-2 p-2"> </span> Progress Update
                    </a>
                </li>
    ...
    <div class="card-body">
        <div class="tab-content">
                ...
                <div class="w-100">
                    ...
                    <form id="taskForm" class="ajax-form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="fv-row row mb-4">
                            ...
                            @if($leader == 1)
                            <div class="col-md-2">
                                <a class="btn btn-sm btn-primary" onclick="createSubtask('{{ $taskProject->TPCode }}','{{ $taskProject->TPName }}','{{ $taskProject->TP_PJCode }}')">Create Subtask</a>
                            </div>
                            @endif
                        ...
                        @else
                            ...
                            <div class="fv-row row mt-10">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" readonly id="parentDetail" name="parentDetail"
                                    placeholder="Parent Task" value="{{ $taskProject->parentTask->TPCode }} - {{ $taskProject->parentTask->TPName }}">
                                </div>
                            </div>
                            ...
                            @if( in_array($taskProject->TPStatus, ['PENDING','FIP']) )
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-5">
                                        ...
                                        <span class="input-group-text cursor-pointer btn btn-info" id="basic-addon2" onclick="viewModal('modal-search')"><i class="fa-solid fa-magnifying-glass"></i></span>
                                    </div>
                                </div>
                                @endif
            ...
            <div id="update_content" class="card-body p-0 tab-pane fade" role="tabpanel" aria-labelledby="update_content">
                <div class="w-100">
