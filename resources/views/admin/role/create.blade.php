                ...
                <div class="row mb-5 d-flex flex-center">
                    ...
                    <div class="col-md-8 card bg-content card-no-border p-5">
                        ...
                        <div class="row flex-row mb-4 text-center">
                            <div class="col">
                                <h3 class="text-light">Add Role</h3>
                            </div>
                        </div>

                        <form class="ajax-form" method="POST" action="{{ route('role.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row p-5">
                                <div class="col-md-12">
                                    <div class="row mb-8">
                                        <div class="col-md-12 mb-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input value="" type="text" name="code" id="code" class="form-control" placeholder="Enter role code">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input value="" type="text" name="name" id="name" class="form-control" placeholder="Enter role name">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-4">
                                                                    ...
                                                                    <div class="form-check form-check-custom form-check-solid">
                                                                        <input class="form-check-input form-check-solid" name="permissionCode[]" type="checkbox" value="{{ $perm->PMCode }}" id="permissionCode" />
