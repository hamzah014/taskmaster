        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6 breadcrumbs-left">
                    <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>{{ __('State')}}</span></h5>
                    ...
                    <div class="col s12">
                        <div class="card">
                            <div class="card-content">
                                <div class="col m6 s6" style=" padding:5px"> <h4 class="card-title">{{ __('List of State')}}</h4></div>
								<div class="col s6 m6 l6" style="text-align:right; padding:5px">
									<a href="{{ route('masterData.state.create') }}" class="waves-effect waves-light btn gradient-45deg-indigo-light-blue">
										<i class="material-icons right">add_circle_outline</i> {{ __('New State')}}</a>
								</div>
                                <div class="row">
                                    <div class="col s12">
  ...
  <script>
        (function ($) {
            ...
            var table = $('#page-length-option').DataTable({
                ...
                ordering:true,
                ajax:  {
                    "url" :"{{ route('masterData.state.datatable') }}",
                    "method": 'POST',
                ...
                columns: [
                    ...
                    { data: 'country', name: 'country', class: 'text-left' },
