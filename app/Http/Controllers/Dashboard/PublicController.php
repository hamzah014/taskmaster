...
class PublicController extends Controller{
    ...
    public function __construct() {
        ...
        $project = Project::where('PJDesc', 'LIKE', '%' . 'PUBLIC' . '%')->first();
    ...
    public function index(){
        ...
        return view('dashboard.public..index',compact('user', 'dataTotal', 'dataRequest', 'dataAmtRequest', 'totalReq' ,'dataExpired'));
    ...
    public function certList(){
        ...
        return view('dashboard.public..totalCert',
    ...
    public function certActive(){
        ...
        return view('dashboard.public..activeCert',
        compact('dateArray', 'totalArray')
        );
    ...
    public function certRevoke(){
        ...
        return view('dashboard.public..revokeCert',
        compact('dateArray', 'totalArray')
        );
    ...
    public function certExpired(){
        ...
        return view('dashboard.public..expiredCert',
        compact('dateArray', 'totalArray')
        );
    ...
    public function certRequest(){
        ...
        return view('dashboard.public..requestCert',
    ...
    public function expiredListCert(){
        ...
        return view('dashboard.public..expiredListCert'
        );
